...
export const metadata: Metadata = {
  ...
  description: `Request a free, no-obligation insurance quote from ${BRAND.name}. We compare business, auto, home, and life coverage across ${BRAND.carriers.length}+ top-rated carriers.`,
  openGraph: {
